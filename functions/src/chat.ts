...
const SYSTEM = `You are Gin Roam's in-app gin guide — warm, knowledgeable, and concise.
Answer questions about gin: how it's made, brands, distilleries, expressions
...
- If a question is clearly unrelated to gin or drinking culture, politely
...
export const handler = async (event: AppSyncEvent): Promise<string> => {
  ...
  if (!message) return "Ask me anything about gin — how it's made, a brand, an expression, a cocktail…";
