    ...
    <>
      ...
      <main className="screen">
        ...
        <div className="card stack">
          ...
          <a className="btn ghost block" href={`https://www.google.com/search?tbm=shop&q=${encodeURIComponent(bottle.name + " gin")}`} target="_blank" rel="noopener noreferrer" style={{ textAlign: "center" }}>🛒 Compare on Google Shopping</a>
