...
const ACTIONS = [
  { to: "/catalog", title: "Explore Gins", sub: "Browse the collection", Icon: GlassIcon, c: "#722F37", c2: "#4a1c22", big: true },
      ...
      <main className="screen home">
        ...
        <motion.div className="home-hero" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
          ...
          <div className="home-hero-text">
            <img src="/logo.svg" alt="Gin Roam" className="home-hero-logo" style={{ height: 28, width: "auto" }} />
