  ...
  return (
    <>
      ...
      <main className="screen info">
        ...
        <p className="lead">
          By using Gin Roam you agree to these terms. Please read them — they
        ...
        <p>
          ...
          States) to use Gin Roam. By using the app you confirm that you are.
        ...
        <p>
          ...
          shown for identification and education (nominative use). Gin Roam is
        ...
        <p>
          To the maximum extent permitted by law, Gin Roam is not liable for any
