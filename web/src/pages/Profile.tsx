...
export default function Profile() {
  ...
  const addReminder = async () => {
    ...
    const r: CloudReminder = {
      id: `${Date.now()}`,
      title: remTitle.trim(),
      message: "Time for a tasting on Gin Roam.",
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="card stack">
              ...
              <div>
                <div className="label">Favorite gin</div>
            ...
            <div className="card stack">
              <div>
                ...
                <input className="field" value={remTitle} onChange={(e) => setRemTitle(e.target.value)} placeholder="e.g. Friday gin night" />
              </div>
              <div>
