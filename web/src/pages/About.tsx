    ...
    <>
      ...
      <main className="screen info">
        <div className="page-title">
          ...
          <h1>About Gin Roam</h1>
        </div>

        <p className="lead">
          Gin Roam turns any get-together into a guided gin tasting. Build a
        ...
        <div className="section-head"><span className="kicker">Why we built it</span><h2>Gin, demystified</h2></div>
        <p>
          Great gin is grain, water, time, and new charred oak — nothing hidden. We make it
        ...
        <ul className="info-list">
          <li><strong>Learn</strong> — how gin is made and what makes each pour different.</li>
        ...
        <p>
          Gin Roam is independent. Bottle names, labels, and logos are trademarks
