...
const FEATURES = [
  { Icon: BookIcon, title: "Learn about gin", body: "Regions, distilleries, tasting technique — no snobbery required.", c: "#5c7a5a", c2: "#3a5438" },
    ...
    <div className="landing">
      ...
      >
        ...
        <div className="land-hero-overlay">
          <div className="land-mark"><BottleMark size={30} /> <span>Gin Roam</span></div>
          ...
          <p className="land-hero-sub">
            Turn any get-together into a guided gin tasting — pour, score each
      ...
      <section className="land-about">
        <div className="section-head land-center">
          ...
          <h2>Your gin companion</h2>
        </div>
        <p className="land-sub land-center-text">
          Gin Roam is a guided home for gin exploration. Build a flight,
