...
const KEY = "gin.onboarded.v1";

const STEPS = [
  { emoji: "🥃", title: "Explore great gins", body: "Browse bottles by style, region, and distillery — from everyday pours to Bottled-in-Bond classics. Look for the badge on Bottled-in-Bond expressions." },
