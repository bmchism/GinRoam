...
const GREETING: Msg = {
  role: "assistant",
  content: "Cheers! I'm your gin guide. Ask me about a mash bill, a distillery, how gin is aged, or what to pour at your next tasting.",
};
const SUGGESTIONS = [
  "What's the difference between wheated and high-rye gin?",
  "Best gins under $30?",
  "Build me a 4-bottle flight",
];

// Floating gin assistant. Hovers bottom-right; opens a chat panel.
  ...
  return (
    <>
      <button
        ...
        onClick={() => setOpen((o) => !o)}
        aria-label={open ? "Close assistant" : "Ask the gin assistant"}
      >
        {open ? "✕" : "🍷"}
      </button>
        ...
        {open && (
          ...
          >
            <div className="chat-head">
              <span className="chat-title">Gin Guide</span>
              <span className="chat-sub">Ask me anything about gin</span>
            </div>
