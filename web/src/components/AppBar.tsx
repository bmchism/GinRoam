...
export default function AppBar({
  ...
  const brand = !back && title === "Gin Roam";
  ...
  const crumbs = back && user ? crumbTrail(pathname, title === "Gin Roam" ? undefined : title) : [];
      ...
      <header className="appbar">
        ...
        {brand ? (
          <Link to="/home" aria-label="Home">
            <img src="/logo.svg" alt="Gin Roam" style={{ height: 30, display: "block" }} />
          </Link>
        ) : (
          <>
            {!back && (
